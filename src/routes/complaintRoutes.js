...
import {createComplaint , getAllComplaints , getComplaintById ,filterComplaints, updateComplaintStatus,deleteComplaint,filterComplaintsByDate} from '../controller/complainControllers.js';
...
complaintRouter.get('/filter/complaint-type',authJWT, isAdmin, filterComplaints);
